...
local runtime_settings = {
	...
	{type = "int-setting",    name = "EAPI_min_time_between_changing_teams", default_value = 1, minimal_value = 0}, -- in minutes
...
local startup_settings = {
	{type = "bool-setting", name = "EAPI_enable_money_recipes", default_value = true},
}
